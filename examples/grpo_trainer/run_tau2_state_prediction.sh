...
# train_dset_fpath=data/state_pred/tau2bench/react-qwen7b-inst-userqwen3-235b-a22b-inst-2507-tmpqwen2.5-step60_h5_3repeats/train_no_empty_samp0.0r.parquet
# train_dset_fpath=data/state_pred/tau2bench/react-qwen7b-inst-userqwen3-235b-a22b-inst-2507-tmpqwen2.5-step60_h5_3repeats/train_shortsubp_noempty_samp0.0r.parquet
...
# dset_short_name=react-qwen7b-userqwen235b-shortsubp-noempty-samp0.0r-tmpqwen2.5-s60h5_3repeats
...
train_dset_fpath=data/state_pred/tau2bench/react-alldomains-qwen7bn8b-userqwen235b-tmpqwen2.5-step60_h5_3repeats/train_shortlongsubp_noempty_samplt0.0trainedr.parquet
val_dset_fpath=data/state_pred/tau2bench/react-alldomains-qwen7bn8b-userqwen235b-tmpqwen2.5-step60_h5_3repeats/test_no_empty_512.parquet
dset_short_name=react-alldomains-qwen7bn8b-userqwen235b-shortlongsubp-noempty-samplt0.0trainedr-s60h5_3repeats
