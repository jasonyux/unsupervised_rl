...
# train_dset_fpath=data/state_pred/tau2bench/react-alldomains-v2nopanocr-q30b-a3b-thinking-2507-userqwen235bngpt4.1-tmpqwen2.5-step60_h5_3repeats/train_noempty_nofterminal_usersub_samplt0.0trainedrt0.85tl0.8.parquet
# val_dset_fpath=data/state_pred/tau2bench/react-alldomains-v2nopanocr-q30b-a3b-thinking-2507-userqwen235bngpt4.1-tmpqwen2.5-step60_h5_3repeats/test_noempty_nofterminal_512.parquet
# dset_short_name=react-alldomains-v2nopanocr-q30ba3b-uq235bngpt4.1-noept-nofterm-usersubp-slt0.0tdrt0.85tl0.8-s60h5_3repeats
# train_dset_fpath=data/state_pred/tau2bench/react-alldomains-v2nopanocr-q30b-a3b-thinking-2507-userqwen235bngpt4.1-tmpqwen2.5-step60_h5_3repeats/train_q30ba3b-q235b-gptoss120b-noempty_nofterminal_usersubp_tmax200_samplt0.0trainedrt0.85tl0.8.parquet
# val_dset_fpath=data/state_pred/tau2bench/react-alldomains-v2nopanocr-q30b-a3b-thinking-2507-userqwen235bngpt4.1-tmpqwen2.5-step60_h5_3repeats/test_noempty_nofterminal_512.parquet
# dset_short_name=react-alldomains-v2nopanocr-q30ba3b-q235b-gptoss120b-noept-nofterm-usersubp-tmax200-slt0.0tdrt0.85tl0.8-s60h5_3repeats
train_dset_fpath=data/state_pred/tau2bench/react-alldomains-v2nopanocr-q30b-a3b-thinking-2507-userqwen235bngpt4.1-tmpqwen2.5-step60_h5_3repeats/train_q30ba3b-q235b-gptoss120b-mistral3-gpt5mini-noempty_nofterminal_usersubp_tmax200_samplt0.0trainedrt0.85tl0.8.parquet
val_dset_fpath=data/state_pred/tau2bench/react-alldomains-v2nopanocr-q30b-a3b-thinking-2507-userqwen235bngpt4.1-tmpqwen2.5-step60_h5_3repeats/test_noempty_nofterminal_512.parquet
dset_short_name=react-alldomains-v2nopanocr-q30ba3b-q235b-gptoss120b-mistral3-gpt5mini-noept-nofterm-usersubp-tmax200-slt0.0tdrt0.85tl0.8-s60h5_3repeats
...
DIST_CKPT_PATH=/data/users/shared/models/Qwen3-30B-A3B-Thinking-2507_torch_dist_verl
# cd verl
...
exp_name=tau2-${model_id}-state_pred-grpo-${reward_short_name}-g${group_size}-${dset_short_name}-kl${kl_loss_coef}-bsz${train_batch_size}ppo${ppo_mini_batch_size}-gen${max_response_length}-jdgd${JUDGE_MAX_TOKEN_TO_JUDGE}-trsh${JUDGE_THRESHOLD}-ep${train_epochs}
