...
train_dset_fpath=data/state_pred/tau2bench/react-alldomains-v2nopanocr-qwen8b-userqwen235bngpt4.1-tmpqwen2.5-step60_h5_3repeats/train_longuser0.3subp_noempty_nofterminal_samplt0.0trainedrt0.85.parquet
val_dset_fpath=data/state_pred/tau2bench/react-alldomains-v2nopanocr-qwen8b-userqwen235bngpt4.1-tmpqwen2.5-step60_h5_3repeats/test_no_empty_no_fterminal_512.parquet
dset_short_name=react-alldomains-v2nopanocr-qwen8b-uq235bngpt4.1-l0.3usubp-noept-nofterm-slt0.0tdrt0.85-s60h5_3repeats
